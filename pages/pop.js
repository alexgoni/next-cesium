...
import VanillaBabylon from "../components/babylon/vanilla_babylon";
import ReactBabylon from "../components/babylon/react_babylon";
  ...
  return (
    <>
      ...
      <div
        ...
        className="absolute left-10 top-10 z-10 hidden cursor-move flex-col overflow-hidden rounded-lg border-4 border-b-8 border-black bg-slate-100 p-4 text-left"
      >
